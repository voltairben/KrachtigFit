 ...
 *
 * Shares the ink canvas with the Reviews section above it (divided by a
 * border, same technique as the Hero/About pairing) rather than alternating,
 * so Faq's existing paper canvas doesn't need to change.
 */
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Reveal delay={0.25}>
            <a
              ...
              className="inline-flex shrink-0 items-center gap-2 text-body-sm font-semibold text-accent"
            >
